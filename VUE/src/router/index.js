...
export const workshopRoutes = [
  ...
  },
  {
    path: '/granule-102',
    component: Workshop,
    meta: { title: '102造粒', apiBase: 'granule102', workshop: '102造粒', permKey: 'granule-102', icon: 'bi-circle' }
  },
  {
    path: '/cold-press-103',
    component: Workshop,
    meta: { title: '103冷压', apiBase: 'cold-press-103', workshop: '103冷压', permKey: 'cold-press-103', icon: 'bi-snow' }
  },
  {
  ...
  },
  {
    path: '/edging-111',
    component: Workshop,
    meta: { title: '111开刃', apiBase: 'edging-111', workshop: '111开刃', permKey: 'edging-111', icon: 'bi-scissors' }
  },
  {
    path: '/final-inspection-112',
    component: Workshop,
    meta: { title: '112终检', apiBase: 'final-inspection-112', workshop: '112终检', permKey: 'final-inspection-112', icon: 'bi-check-circle' }
  },
  {
    path: '/warehouse-113',
    component: Workshop,
  ...
  },
  {
    path: '/canteen',
    component: Workshop,
    meta: { title: '食堂', apiBase: 'canteen', workshop: '食堂', permKey: 'canteen', icon: 'bi-cup-hot' }
  },
  {
    path: '/dormitory',
    component: Workshop,
