...
public class AirConditioningController {
    ...
    @ApiOperation("电能消耗卡片（114_空调水机主机，后端计算差值）")
    ...
    public BaseResponse<Double> getEnergyConsumption(
        ...
        try {
            Double consumption = airConditioningService.getEnergyConsumption(startTime, endTime, mode);
