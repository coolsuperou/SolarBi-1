...
public class FeedingWorkshopController {
    ...
    public BaseResponse<TempMonitorStatistics> getStatistics(
        ...
        try {
            TempMonitorStatistics statistics = feedingWorkshopService.getStatistics("103冷压", startTime, endTime);
    ...
    public BaseResponse<Double> getEnergyConsumption(
        ...
        try {
            Double consumption = feedingWorkshopService.getEnergyConsumption(startTime, endTime, mode);
