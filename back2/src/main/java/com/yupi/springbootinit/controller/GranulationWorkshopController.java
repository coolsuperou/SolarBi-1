 ...
 * @author yupi
 */
@Api(tags = "102造粒环保设备温湿电能监控数据管理")
@RestController
@RequestMapping("/granulation-workshop")
@Slf4j
public class GranulationWorkshopController {

    @Autowired
    private GranulationWorkshopService granulationWorkshopService;
