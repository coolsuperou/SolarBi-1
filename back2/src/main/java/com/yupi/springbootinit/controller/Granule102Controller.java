...
@Api(tags = "102造粒电能监控数据管理")
@RestController
@RequestMapping("/granule102")
@Slf4j
public class Granule102Controller {

    @Autowired
    private Granule102Service granule102Service;
    ...
    public BaseResponse<List<TempMonitor>> getLatestData() {
        List<TempMonitor> dataList = granule102Service.getLatestData();
    ...
    public BaseResponse<List<TempMonitor>> getDataByWorkshop(
        ...
        List<TempMonitor> dataList = granule102Service.getDataByWorkshop(workshop);
        return ResultUtils.success(dataList);
    }
    ...
    public BaseResponse<List<String>> getAllWorkshops() {
        List<String> workshops = granule102Service.getAllWorkshops();
    ...
    public BaseResponse<Page<TempMonitor>> queryByCondition(@RequestBody TempMonitorQueryRequest request) {
        ...
        Page<TempMonitor> page = granule102Service.queryByCondition(request);
        return ResultUtils.success(page);
    }

    @ApiOperation("获取电能趋势数据（固定102造粒）")
    ...
    public BaseResponse<List<TempMonitor>> getElectricEnergyTrend(
        ...
        try {
            ...
            List<TempMonitor> trendData = granule102Service.getElectricEnergyTrend(fixedWorkshop, deviceId, startTime, endTime, finalLimit);
    ...
    public BaseResponse<List<HourlyEnergyConsumption>> getHourlyEnergyConsumption(
        ...
        try {
            ...
            List<HourlyEnergyConsumption> consumptionData = granule102Service.getHourlyEnergyConsumption(fixedWorkshop, deviceId, startTime, endTime);
    ...
    public BaseResponse<List<HourlyEnergyConsumption>> getHourlyEnergyConsumptionQuery(
        ...
        try {
            ...
            List<HourlyEnergyConsumption> consumptionData = granule102Service.getHourlyEnergyConsumptionQuery(fixedWorkshop, deviceId, startTime, endTime);
            return ResultUtils.success(consumptionData);
        } catch (Exception e) {
    ...
    public BaseResponse<List<DailyEnergyConsumption>> getDailyEnergyConsumptionQuery(
        ...
        try {
            ...
            List<DailyEnergyConsumption> consumptionData = granule102Service.getDailyEnergyConsumptionQuery(fixedWorkshop, deviceId, startTime, endTime);
            return ResultUtils.success(consumptionData);
        } catch (Exception e) {
    ...
    public BaseResponse<Boolean> refreshCache(
            @ApiParam("车间名称，可为空，默认102造粒") @RequestParam(required = false) String workshop) {
        try {
            String fixedWorkshop = (workshop == null || workshop.isEmpty()) ? "102造粒" : workshop;
            // 重建一年窗口缓存并原子切换
    ...
    public BaseResponse<TempMonitorStatistics> getStatistics(
        ...
        try {
            // 强制限定车间为 102造粒
            String fixedWorkshop = "102造粒";
            TempMonitorStatistics statistics = granule102Service.getStatistics(fixedWorkshop, startTime, endTime);
