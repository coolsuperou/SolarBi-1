...
@Api(tags = "110注射环保设备电能监控数据管理")
@RestController
@RequestMapping("/injection-workshop")
@Slf4j
public class InjectionWorkshopController {
    ...
    @ApiOperation("获取最新温湿电能数据（110注射环保设备）")
    @GetMapping("/latest")
    public BaseResponse<List<TempMonitor>> getLatestData() {
        List<TempMonitor> dataList = injectionWorkshopService.getLatestData();
        return ResultUtils.success(dataList);
    }

    @ApiOperation("按车间查询温湿电能数据（110注射环保设备）")
    ...
    public BaseResponse<List<TempMonitor>> getDataByWorkshop(
        ...
        List<TempMonitor> dataList = injectionWorkshopService.getDataByWorkshop(workshop);
        return ResultUtils.success(dataList);
    }

    @ApiOperation("获取所有车间列表（110注射环保设备）")
    @GetMapping("/workshops")
    public BaseResponse<List<String>> getAllWorkshops() {
        List<String> workshops = injectionWorkshopService.getAllWorkshops();
    ...
    public BaseResponse<Page<TempMonitor>> queryByCondition(@RequestBody TempMonitorQueryRequest request) {
        ...
        Page<TempMonitor> page = injectionWorkshopService.queryByCondition(request);
        return ResultUtils.success(page);
    }

    @ApiOperation("获取统计信息（110注射环保设备）")
    ...
    public BaseResponse<TempMonitorStatistics> getStatistics(
        ...
        try {
            TempMonitorStatistics statistics = injectionWorkshopService.getStatistics("110注射环保设备", startTime, endTime);
    ...
    @ApiOperation("获取电能趋势数据（110注射环保设备）")
    ...
    public BaseResponse<List<TempMonitor>> getElectricEnergyTrend(
        ...
        try {
            ...
            List<TempMonitor> trendData = injectionWorkshopService.getElectricEnergyTrend(fixedWorkshop, deviceId, startTime, endTime, finalLimit);
    ...
    @ApiOperation("获取每小时电能消耗数据（110注射环保设备，默认模式-实时更新）")
    ...
    public BaseResponse<List<HourlyEnergyConsumption>> getHourlyEnergyConsumption(
        ...
        try {
            ...
            List<HourlyEnergyConsumption> consumptionData = injectionWorkshopService.getHourlyEnergyConsumption(fixedWorkshop, deviceId, startTime, endTime);
    ...
    @ApiOperation("获取每小时电能消耗数据（110注射环保设备，查询模式-历史数据）")
    ...
    public BaseResponse<List<HourlyEnergyConsumption>> getHourlyEnergyConsumptionQuery(
        ...
        try {
            ...
            log.info("🔵 Controller调用查询模式API: /electric-energy-hourly-consumption-query - 车间: {}, 设备: {}, 开始时间: {}, 结束时间: {}",
                    fixedWorkshop, deviceId, startTime, endTime);
            List<HourlyEnergyConsumption> consumptionData = injectionWorkshopService.getHourlyEnergyConsumptionQuery(fixedWorkshop, deviceId, startTime, endTime);
            return ResultUtils.success(consumptionData);
        } catch (Exception e) {
    ...
    @ApiOperation("获取每日电能消耗数据（110注射环保设备，查询模式-历史数据）")
    ...
    public BaseResponse<List<DailyEnergyConsumption>> getDailyEnergyConsumptionQuery(
        ...
        try {
            ...
            log.info("🟡 Controller调用日模式查询API: /electric-energy-daily-consumption-query - 车间: {}, 设备: {}, 开始时间: {}, 结束时间: {}",
                    fixedWorkshop, deviceId, startTime, endTime);
            List<DailyEnergyConsumption> consumptionData = injectionWorkshopService.getDailyEnergyConsumptionQuery(fixedWorkshop, deviceId, startTime, endTime);
            return ResultUtils.success(consumptionData);
        } catch (Exception e) {
