...
public class InjectionWorkshopController {
    ...
    @ApiOperation("电能消耗卡片（110注射环保设备，后端计算差值）")
    ...
    public BaseResponse<Double> getEnergyConsumption(
        ...
        try {
            Double consumption = injectionWorkshopService.getEnergyConsumption(startTime, endTime, mode);
