...
} from '@/services/SolarBi-front/airCompressor114Controller';
// 第10行后：添加import
 ...
 * @constructor
 */
const Aircompressor114Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>114空压机电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Aircompressor114Page;
