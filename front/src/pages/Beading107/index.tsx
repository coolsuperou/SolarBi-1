...
} from '@/services/SolarBi-front/beading107Controller';
// 第10行后：添加import
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>107串珠电能数据监控</span>),
        breadcrumb: {},
      }}
