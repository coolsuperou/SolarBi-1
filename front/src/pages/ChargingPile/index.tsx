...
} from '@/services/SolarBi-front/chargingPileController';
// 第10行后：添加import
 ...
 * @constructor
 */
const ChargingpilePage: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>充电桩电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default ChargingpilePage;
