...
} from '@/services/SolarBi-front/cleaning106Controller';
// 第10行后：添加import
 ...
 * @constructor
 */
const Cleaning106Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>106清洗电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Cleaning106Page;
