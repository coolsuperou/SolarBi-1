...
} from '@/services/SolarBi-front/coldPress103Controller';
// 第10行后：添加import
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>103冷压电能数据监控</span>),
        breadcrumb: {},
      }}
