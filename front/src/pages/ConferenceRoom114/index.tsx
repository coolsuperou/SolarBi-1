...
} from '@/services/SolarBi-front/conferenceRoom114Controller';
// 第10行后：添加import
...
// 固定目标车间
const TARGET_WORKSHOP = '114_2#楼会议室';
 ...
 * @constructor
 */
const ConferenceRoom114Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>114_2#楼会议室电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default ConferenceRoom114Page;
