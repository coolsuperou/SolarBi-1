...
} from '@/services/SolarBi-front/elevator114Controller';
// 第10行后：添加import
...
// 固定目标车间
const TARGET_WORKSHOP = '114_2#厂房电梯';
 ...
 * @constructor
 */
const Elevator114Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>114_2#厂房电梯电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Elevator114Page;
