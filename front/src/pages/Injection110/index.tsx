...
} from '@/services/SolarBi-front/injection110Controller';
// 第10行后：添加import
 ...
 * @constructor
 */
const Injection110Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>110注射电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Injection110Page;
