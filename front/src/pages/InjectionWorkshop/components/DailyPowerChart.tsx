...
const DailyPowerChart: React.FC<DailyPowerChartProps> = ({ chartOptions, trendData, isMobile, isSmallMobile, darkThemeStyles }) => {
  return (
    <Card
      title={
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <Space>
            ...
            <span style={darkThemeStyles.title}>110注射环保设备 日电能消耗监控</span>
          </Space>
          <Space>
            <Badge
              status="processing"
