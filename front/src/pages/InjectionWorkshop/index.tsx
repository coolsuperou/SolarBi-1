...
} from '@/services/SolarBi-front/injectionWorkshopController';
...
import { getColumns } from './config/columns';
  ...
  // 固定目标车间
const TARGET_WORKSHOP = '110注射环保设备';
 ...
 * @constructor
 */
const InjectionWorkshopPage: React.FC = () => {
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>110注射环保设备电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default InjectionWorkshopPage;
