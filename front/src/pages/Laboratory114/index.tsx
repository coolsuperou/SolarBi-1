...
} from '@/services/SolarBi-front/laboratory114Controller';
// 第10行后：添加import
...
// 固定目标车间
const TARGET_WORKSHOP = '114_2#楼实验室';
 ...
 * @constructor
 */
const Laboratory114Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>114_2#楼实验室电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Laboratory114Page;
