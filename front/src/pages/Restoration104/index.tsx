 ...
 * @constructor
 */
const Restoration104Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>104还原电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Restoration104Page;
