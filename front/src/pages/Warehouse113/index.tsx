...
} from '@/services/SolarBi-front/warehouse113Controller';
// 第10行后：添加import
 ...
 * @constructor
 */
const Warehouse113Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>113仓库电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default Warehouse113Page;
