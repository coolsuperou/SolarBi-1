...
} from '@/services/SolarBi-front/finalInspection112Controller';
// 第10行后：添加import
 ...
 * @constructor
 */
const finalInspection112Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>112终检电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default finalInspection112Page;
