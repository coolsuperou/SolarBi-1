...
} from '@/services/SolarBi-front/officeArea114Controller';
// 第10行后：添加import
...
// 固定目标车间
const TARGET_WORKSHOP = '114_2#楼办公区域';
 ...
 * @constructor
 */
const OfficeArea114Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>114_2#楼办公区域电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default OfficeArea114Page;
