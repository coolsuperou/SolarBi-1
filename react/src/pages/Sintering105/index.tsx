...
} from '@/services/SolarBi-front/sintering105Controller';
// 第10行后：添加import
 ...
 * @constructor
 */
const  Sintering105Page: React.FC = () => {
...
// 加载电能消耗数据
  ...
  return (
    ...
    <PageContainer
      header={{
          title: (<span style={darkThemeStyles.title}>105烧结电能数据监控</span>),
        breadcrumb: {},
      }}
...
export default  Sintering105Page;
